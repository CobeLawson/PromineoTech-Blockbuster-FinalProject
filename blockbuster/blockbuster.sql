...
CREATE TABLE reviews (
	...
	FOREIGN KEY (product_fk) 
		REFERENCES products (product_pk) ON DELETE CASCADE,
	FOREIGN KEY (customer_fk) 
		REFERENCES customers (customer_pk)
);

-- reviews data --
INSERT INTO reviews (review_string, product_fk, customer_fk) VALUES ('Excellent cast but disappointing ending.', 1065, 1);
INSERT INTO reviews (review_string, product_fk, customer_fk) VALUES ('Boring and hard to follow', 1016, 2);
INSERT INTO reviews (review_string, product_fk, customer_fk) VALUES ('Great effects and action scenes', 1006, 3);
INSERT INTO reviews (review_string, product_fk, customer_fk) VALUES ('The gameplay was fun but the campaign was far too short.', 2010, 4);
INSERT INTO reviews (review_string, product_fk, customer_fk) VALUES ('too buggy', 2034, 5);
